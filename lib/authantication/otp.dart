...
import 'package:v_bhartiya/userMainScreen.dart';
...
class _OtpState extends State<Otp> {
  ...
  void verifyButtonfun() {
    ...
    if (otp == '0000') {
      // Go to welcome
      stopTimer();
      Get.off(MainScreenUser(),transition: Transition.upToDown, duration: Duration(seconds: 1));
    } else {
      setState(() {
        invalidOtp = true;
      });
      ...
      body: Center(
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                Image.asset('assets/onboarding/Otp.png', width: 250, height: 250,),
                const Text(
                  'Verification Code',
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    backgroundColor: Color.fromRGBO(64,123,255,0.8),
                  ),
                  child: const Text(
                    'Verify',
